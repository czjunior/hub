...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Municípios'])
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h6>Lista dos Municípios</h6>
                    </div>
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                ...
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm">{{ $mun['nome_municipio'] }}</h6>
                                                    <p class="text-xs text-secondary mb-0">Prefeito </p>
                                                </div>
                                                <div>
                                                    &nbsp;
                                                </div>
                                                <div>
                                                        <form role="form" method="POST" action="{{ route('cidade-show') }}">
                                                            @csrf
                                                            @method('post')
                                                            <input type="hidden" name="codigo_municipio" value="{{ $mun['codigo_municipio'] }}" />
                                                            <button type="submit" alt="Ver Mais" title="Ver Mais" class="btn btn-primary btn-xs ms-auto"><i class="ni ni-zoom-split-in"></i></button>
                                                        </form>    
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <p class="text-xs font-weight-bold mb-0">{{ $mun['codigo_municipio'] }}</p>
                                            <p class="text-xs text-secondary mb-0">geonamesId {{ $mun['geonamesId'] }}</p>
                                        </td>
                                        <!--td class="align-middle text-center text-sm">
                                            <span class="badge badge-sm bg-gradient-success">Online</span>
                                            href="{{ route('orgao-show2', ['id' => $mun['codigo_municipio']]) }}"
                                        </td-->
                                        <td class="align-middle text-center">
                                            <span class="text-secondary text-xs font-weight-bold">{{ $mun['geoibgeId'] }}</span>
                                        </td>
                                        <td class="align-middle">
                                            <form role="form" method="POST" action="{{ route('orgao-show2') }}">
                                                @csrf
                                                @method('post')
                                                <input type="hidden" name="codigo_municipio" value="{{ $mun['codigo_municipio'] }}" />
                                                <button type="submit" alt="Ver Órgãos" title="Ver Órgãos" class="btn btn-primary btn-xs ms-auto">
                                                    <svg class="text-white" width="16px" height="16px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"> <title>office</title> <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"> <g id="Rounded-Icons" transform="translate(-1869.000000, -293.000000)" fill="#FFFFFF" fill-rule="nonzero"> <g id="Icons-with-opacity" transform="translate(1716.000000, 291.000000)"> <g id="office" transform="translate(153.000000, 2.000000)"> <path class="color-background" d="M12.25,17.5 L8.75,17.5 L8.75,1.75 C8.75,0.78225 9.53225,0 10.5,0 L31.5,0 C32.46775,0 33.25,0.78225 33.25,1.75 L33.25,12.25 L29.75,12.25 L29.75,3.5 L12.25,3.5 L12.25,17.5 Z" id="Path" opacity="0.6"></path> <path class="color-background" d="M40.25,14 L24.5,14 C23.53225,14 22.75,14.78225 22.75,15.75 L22.75,38.5 L19.25,38.5 L19.25,22.75 C19.25,21.78225 18.46775,21 17.5,21 L1.75,21 C0.78225,21 0,21.78225 0,22.75 L0,40.25 C0,41.21775 0.78225,42 1.75,42 L40.25,42 C41.21775,42 42,41.21775 42,40.25 L42,15.75 C42,14.78225 41.21775,14 40.25,14 Z M12.25,36.75 L7,36.75 L7,33.25 L12.25,33.25 L12.25,36.75 Z M12.25,29.75 L7,29.75 L7,26.25 L12.25,26.25 L12.25,29.75 Z M35,36.75 L29.75,36.75 L29.75,33.25 L35,33.25 L35,36.75 Z M35,29.75 L29.75,29.75 L29.75,26.25 L35,26.25 L35,29.75 Z M35,22.75 L29.75,22.75 L29.75,19.25 L35,19.25 L35,22.75 Z"></path> </g> </g> </g> </g> </svg></button>
