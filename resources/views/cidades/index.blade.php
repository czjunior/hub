                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                ...
                                                <div class="d-flex flex-column justify-content-center">
                                                    <a href="{{ route('cidade-show') }}" class="text-secondary font-weight-bold text-xs">
                                        ...
                                        <td class="align-middle">
                                            <a href="{{ route('orgao-show2', ['id' => $mun['codigo_municipio']]) }}" class="text-secondary font-weight-bold text-xs"
