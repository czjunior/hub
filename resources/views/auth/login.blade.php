        ...
        <section>
            <div class="page-header min-vh-100">
                        ...
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                            <div class="card card-plain">
                                <div class="card-header pb-0 text-start">
                                    ...
                                    <p class="mb-0">Digite seu email e senha para acessar</p>
                                </div>
                                <div class="card-body">
                                ...
                                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                    <p class="mb-1 text-sm mx-auto">
                                        Esqueceu a senha? Reinicie sua senha
              ...
              background-size: cover;">
                                ...
                                <h4 class="mt-5 text-white font-weight-bolder position-relative">"Assessoria na Gestão Municipal"</h4>
                                <p class="text-white position-relative">Otimizando os processos e agilizando trabalhos se ganha em performance e efetividade.</p>
                            </div>
                        </div>
                    </div>
                </div>
